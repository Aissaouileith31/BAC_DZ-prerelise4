"""---the home page---"""
#note: all fream in the app are the same code just 
#collor and text and function of button 
#use the guid in lessons.py in line 65 for more info

from flet import *
from base64_string_icon_path import icons
hovering = False

#this functions are what make the page change to ther button
def home(page):
    """---home main function---"""
    page.padding=1
    page.bgcolor="#2F4F7F"
